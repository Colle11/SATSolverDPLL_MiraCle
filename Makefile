...
$(BIN_DIR)/SATSolverDPLL_MRC_JW_OS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
	nvcc $(NVCCFLAGS) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/miracle.o $(BUILD_DIR)/utils.o -DMRC -DJW_OS -DSTATS -o $@

$(BIN_DIR)/SATSolverDPLL_MRC_JW_TS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
	nvcc $(NVCCFLAGS) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/miracle.o $(BUILD_DIR)/utils.o -DMRC -DJW_TS -DSTATS -o $@

$(BIN_DIR)/SATSolverDPLL_MRC_BOHM_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
	nvcc $(NVCCFLAGS) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/miracle.o $(BUILD_DIR)/utils.o -DMRC -DBOHM -DSTATS -o $@

$(BIN_DIR)/SATSolverDPLL_MRC_POSIT_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
	nvcc $(NVCCFLAGS) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/miracle.o $(BUILD_DIR)/utils.o -DMRC -DPOSIT -DSTATS -o $@

$(BIN_DIR)/SATSolverDPLL_MRC_DLIS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
	nvcc $(NVCCFLAGS) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/miracle.o $(BUILD_DIR)/utils.o -DMRC -DDLIS -DSTATS -o $@

$(BIN_DIR)/SATSolverDPLL_MRC_DLCS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BIN_DIR)/SATSolverDPLL_MRC_GPU_JW_OS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_gpu.cuh $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BIN_DIR)/SATSolverDPLL_MRC_GPU_JW_TS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_gpu.cuh $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BIN_DIR)/SATSolverDPLL_MRC_GPU_BOHM_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_gpu.cuh $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BIN_DIR)/SATSolverDPLL_MRC_GPU_POSIT_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_gpu.cuh $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BIN_DIR)/SATSolverDPLL_MRC_GPU_DLIS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_gpu.cuh $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BIN_DIR)/SATSolverDPLL_MRC_GPU_DLCS_STATS: $(BIN_DIR) $(SRC_DIR)/solver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/miracle.cuh $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_gpu.cuh $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(SRC_DIR)/utils.cuh $(BUILD_DIR)/utils.o $(SRC_DIR)/sig_handling.h
...
$(BUILD_DIR)/cnf_formula.o: $(BUILD_DIR) $(SRC_DIR)/cnf_formula.cuh $(SRC_DIR)/cnf_formula.cu $(SRC_DIR)/cnf_formula_types.cuh $(SRC_DIR)/utils.cuh
	nvcc $(NVCCFLAGS) -c $(SRC_DIR)/cnf_formula.cu -o $@

$(BUILD_DIR)/cnf_formula_gpu.o: $(BUILD_DIR) $(SRC_DIR)/cnf_formula_gpu.cuh $(SRC_DIR)/cnf_formula_gpu.cu $(SRC_DIR)/cnf_formula.cuh $(SRC_DIR)/utils.cuh
	nvcc $(NVCCFLAGS) -c $(SRC_DIR)/cnf_formula_gpu.cu -o $@

$(BUILD_DIR)/miracle.o: $(BUILD_DIR) $(SRC_DIR)/miracle.cuh $(SRC_DIR)/miracle.cu $(SRC_DIR)/cnf_formula.cuh $(SRC_DIR)/utils.cuh
	nvcc $(NVCCFLAGS) -c $(SRC_DIR)/miracle.cu -o $@

$(BUILD_DIR)/miracle_dynamic.o: $(BUILD_DIR) $(SRC_DIR)/miracle_dynamic.cuh $(SRC_DIR)/miracle_dynamic.cu $(SRC_DIR)/cnf_formula.cuh $(SRC_DIR)/utils.cuh
	nvcc $(NVCCFLAGS) -c $(SRC_DIR)/miracle_dynamic.cu -o $@

$(BUILD_DIR)/miracle_gpu.o: $(BUILD_DIR) $(SRC_DIR)/miracle_gpu.cuh $(SRC_DIR)/miracle_gpu.cu $(SRC_DIR)/cnf_formula_gpu.cuh $(SRC_DIR)/miracle.cuh $(SRC_DIR)/utils.cuh $(SRC_DIR)/launch_parameters_gpu.cuh
	nvcc $(NVCCFLAGS) -c $(SRC_DIR)/miracle_gpu.cu -o $@

$(BUILD_DIR)/utils.o: $(BUILD_DIR) $(SRC_DIR)/utils.cuh $(SRC_DIR)/utils.cu $(SRC_DIR)/launch_parameters_gpu.cuh
